...
- The system automatically filters meal kits based on user profile information such as:

- Dietary preferences (e.g. vegetarian, pescatarian, balanced diet, mediterranean)
- Food allergies (e.g. nuts, seafood, dairy)

Only safe and relevant meal kits will be displayed to each user, reducing the risk of allergic reactions and improving usability.
